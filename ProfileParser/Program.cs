...
/*
var auth = new ProfileAuthorization(new AuthorizationOptions()
{
...
var isAuthorized = auth.Authorize(login, password);
if (isAuthorized)
{
    Console.WriteLine("Wait....");
    Console.ReadKey();
    var parser = new InstagramParser(new InstagramProfileParsingOptions()
    {
    ...
    await parser.Save(new JsonSaveData());
}
*/
